...
public class ArticleRepositoryTransactionTest {
  ...
  public void transactional_test() {
    ...
    Article article = new Article("test", "desc", "body", new String[]{"java", "spring"},
        user.getId());
    articleRepository.save(article);
    Article anotherArticle = new Article("test", "desc", "body",
        new String[]{"java", "spring", "other"}, user.getId());
    try {
